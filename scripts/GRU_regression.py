...
class GRU(nn.Module):
    def __init__(self, n_input_features, hidden_layer_size, num_layers):
        super(GRU, self).__init__()
        self.n_input_features = n_input_features
        self.hidden_layer_size = hidden_layer_size
        self.num_layers = num_layers
        self.gru = nn.GRU(
            n_input_features, hidden_layer_size, num_layers, batch_first=True
        )
...
model = GRU(n_features, hidden_layer_size, 3)
